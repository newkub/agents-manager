...
export default function DatasetsPage() {
  return (
    <div class="p-6">
      <div class="mb-6">
        <h1 class="text-2xl font-bold text-text-primary mb-2">📊 Datasets</h1>
        <p class="text-text-secondary">Browse and manage your training datasets</p>
      </div>
      ...
      <div class="bg-bg-secondary border border-border rounded-lg p-6">
        <div class="text-center py-12 text-text-secondary">
          ...
          <p class="text-sm mb-4">No datasets yet. Upload your first dataset.</p>
          <button
            type="button"
